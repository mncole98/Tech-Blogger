...
const postData = [
    ...
    },
    {
        ...
        content: "npm 7 was just published as latest to the npm registry last week, and it is now the default version you get when you run npm install --global npm. Workspaces – By far the most-requested feature by npm users everywhere, this new set of npm CLI features lets you manage multiple packages from within a singular, top-level root package.",
        user_id: 2
    },
    {
